...
import MusicListItems from './component/MusicListItems'
...
class App extends Component {
  ...
  deleteSongAlbum = id => {
    ...
    const FilteredList = playList.filter(eachSong => eachSong.id !== id)
  ...
  renderNoSearchResult = () => (
    <div className="no-search-result-container">
      <p className="no-search-result-heading">No Songs Found</p>
    </div>
  )
